                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4 border border-info">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-info">Update Appointment</h6>
                                    
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="{{ url('/updateAppointments/'.$appointment->id) }}" method="post">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <option value="3" @selected( old('status' == 3))>Done</option>
                                            </select>
                                        </div>
                                        <div class="col-md-14 mb-3">
                                            <label for="inputState" class="form-label">Select Doctor <span class="text-danger">*</span></label>
                                            <select id="inputState" disabled class="form-select border border-info" name="select_doctor">
                                            @foreach ($dentist as $doc)
                                                <option value="{{$doc->id }}">Dr. {{$doc->firstname }}</option>
                                            @endforeach
                                            </select> 
                                        </div>
                                        <div class="d-grid gap-2 d-md-block float-end">
                                            <a href="{{ route('admin.dashboard') }}" class="btn btn-danger" type="button">Back</button></a>
