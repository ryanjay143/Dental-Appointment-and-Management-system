                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4 mt-5 border border-info">
                                ...
                                <div class="card-header bg-light py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 display-6 text-info">View Order</h6>
                                    <a href="{{ route ('payment') }}" type="button" class="btn btn-danger btn-sm">Back to Payment</a>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ($viewOrder as $order)
                                                <tr>
                                                    ...
                                                    <td class="text-info">{{$order->product_name}}</td>
                                                    <td>
                                                        <img src="{{ asset($order->product_image) }}" class="rounded" style="width: 30%; height: 10vh;" alt="...">
                                                    </td>
