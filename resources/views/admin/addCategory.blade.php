                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="card shadow mb-5 mt-5">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-info">Add Dental Categories</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    {!! csrf_field() !!}
                                        ...
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput2" class="form-label">Category Image</label>
                                        ...
                                        <div class="d-grid gap-2 d-md-block float-end">
                                            <a href="{{ route('category.products') }}" class="btn btn-danger text-capitalize" type="button">Back</a>
                                            <button class="btn btn-info text-capitalize text-light fw-bold" type="submit">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
