                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="inputPassword" value="{{ $users->firstname }}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">Lastname</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="inputPassword" value="{{ $users->lastname }}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="inputPassword" value="{{ $users->email }}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">Phone Number</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="inputPassword" value="{{ $users->phone_number }}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">User type</label>
                                            <div class="col-sm-6">
                                                <input type="text" readonly class="form-control" id="inputPassword" value="@if($users->user_type ==0)Patient @elseif($users->user_type ==1)Admin @elseif($users->user_type ==2)dentist @endif">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="d-grid gap-2 d-md-block float-end">
                                            <a href="{{ route('users.manage') }}" class="btn btn-danger" type="button">Back</a>
