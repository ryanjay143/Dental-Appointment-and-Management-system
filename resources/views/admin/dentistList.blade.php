                                        ...
                                        <tbody class="text-dark">
                                            ...
                                            @foreach ($user as $acc)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/dental/'.$acc->id) }}" type="button" class="btn btn-info btn-sm fw-bold"><i class="far fa-eye"></i></a>
                                                        <!-- <a href="{{ url('/dental/'.$acc->id . '/edit') }}" type="button" class="btn btn-success btn-sm"><i class="far fa-edit fa-xs"></i></i></button></a> -->
                                                        <button type="button" class="btn btn-danger btn-sm" title="Delete dentist" onclick="return confirm("Confirm Delete?") data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-trash-alt fa-xs"></i></button>
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <div class="text-center">
                                                                            <i class="fas fa-circle-xmark fa-6x text-danger m-3"></i>
                                                                            <p class="fs-4">Are you sure want to delete this record?</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-info" data-bs-dismiss="modal">Cancel</button>
                                                                        <form action="{{ url('/dental' . '/'.$acc->id) }}" method="post" accept-charset="UTF-8" style="display:inline;">
                                                                            {{ method_field('DELETE') }} 
                                                                            {{ csrf_field() }}
                                                                            <button type="submit" class="btn btn-danger" title="Delete dentist" onclick="return confirm("Confirm Delete?")>Delete</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>
