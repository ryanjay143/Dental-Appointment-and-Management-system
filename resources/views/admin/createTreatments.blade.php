                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="card shadow mb-5 mt-5">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-info">Add New Treatments</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="{{ route('dental.treat') }}" method="post" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Treatment Name">
                                        </div>
                                        <div class="mb-3">
