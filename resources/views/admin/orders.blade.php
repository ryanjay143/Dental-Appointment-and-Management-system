                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4 mt-5 border border-info">
                                ...
                                <div class="card-header bg-light py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 display-6 text-info">List of Pending Orders</h6>
                                    ...
                                    <table id="example" class="table">
                                        ...
                                        @foreach ($order as $orders)
                                            <tr>
                                                ...
                                                <td>&#8369; {{$orders->total}}</td>
                                                <form action="{{ url('changeOrderStatus/'.$orders->id) }}" method="post">
                                                    @csrf
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic example" style="display: inline-block;">
                                                        <a href="{{ url('adminViewOrder/'.$orders->id) }}" type="button" class="btn btn-info btn-sm text-capitalize"><i class="fas fa-eye"></i></a>
                                                        <button class="btn btn-success btn-sm text-capitalize" type="submit">Confirm Order</button>
                                                    </div>
                                                </form>
                                                </td>
                                            </tr>
