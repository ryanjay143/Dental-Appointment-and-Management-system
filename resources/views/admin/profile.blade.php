                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4 mt-5 border border-info">
                                ...
                                <div class="card-body">
                                    <center>
                                        <img src="{{ (!empty($adminData->photo))? url('upload/admin_profile/'.$adminData->photo):url('images/avatar/profile.jpg') }}" class="rounded-circle avatar-xl mb-5" style="width: 150px;" alt="">
                                    </center>
                                    <h6 class="card-title">Name: {{ $adminData->firstname}} {{ $adminData->lastname}}</h6><hr>
                                    <h6 class="card-title">Username: {{ $adminData->username}}</h6><hr>
                                    <h6 class="card-title">Email: {{ $adminData->email}}</h6><hr>
                                    <h6 class="card-title">Phone Number: {{ $adminData->phone_number}}</h6><hr>
                                    <h6 class="card-title">User type:
                                        @if ( $adminData->user_type == 1)
                                        <span>Admin</span>
                                        @endif
                                    </h6><hr>
                                    <div class="d-grid gap-2 d-md-block float-end">
                                        <a href="{{ route('admin.dashboard') }}" class="btn btn-danger btn-sm" type="button">Back</a>
                                        <a href="{{ route('edit.Editprofile') }}" class="btn btn-info btn-sm" type="button">Edit Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
