                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-5 mt-5">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-info">Dental Categories</h6>
                                    <a href="{{ route('add.category') }}" type="button" class="btn btn-info text-capitalize fw-bold btn-sm"><i class="fas fa-plus-circle"></i> Add Category</a>
                                        ...
                                        <tbody>
                                            @foreach ($category as $cat)
                                                <tr>
                                                    ...
                                                    <td>{{$cat->name }}</td>
                                                    <td>
                                                        <img src="{{ asset($cat->image) }}" class="card-img-top" style="height: 8vh; width: 35%;" alt="...">
                                                    </td>
                                                    <td >
