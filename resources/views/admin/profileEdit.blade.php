                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4 mt-5 border border-info">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                   <form action="{{ route('store.adminProfile') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="text" class="col-sm-2 col-form-label">Lastname:</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $editData->phone_number }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="text" class="col-sm-2 col-form-label">Profile Photo</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <img id="showImage" src="{{ (!empty($editData->photo))? url('upload/admin_profile/'.$editData->photo):url('images/avatar/profile.jpg') }}" class="rounded avatar-sm" style="width: 150px;" alt="">
                                        </div>
                                    </div>
                                    <div class="d-grid gap-2 d-md-block float-end">
                                        <a href="{{ route('admin.profile') }}" class="btn btn-danger btn-sm" type="button">Back</a> 
