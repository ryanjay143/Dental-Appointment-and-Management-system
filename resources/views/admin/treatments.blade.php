...
<body id="page-top">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-5 mt-5">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-info">Dental Treatments</h6>
                                    <a href="{{ url('/treatments/create') }}" button type="button" class="btn btn-info text-capitalize"><i class="fas fa-plus-circle"></i> Add Treatments</button></a>
                                </div>
                                ...
                                <div class="card-body">
                                    <table id="example" class="table">
                                        <thead class="table-info">
                                            ...
                                            <th scope="col"><p class="fw-bold">Treatments Name</p></th>
                                            <th scope="col"><p class="fw-bold">Treatments Image</p></th>
                                            <th scope="col"><p class="fw-bold">Price</p></th>
                                            <th scope="col"><p class="fw-bold">Action</p></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            
                                                @foreach ($treatments as $treats)
                                                <tr>
                                                        ...
                                                        <!-- <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p class="text-center fs-5">Are you sure want to delete this data?</p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">no</button>
                                                                    <form action="{{ url('/treatments' . '/'.$treats->treatment_id ) }}" method="post" accept-charset="UTF-8" style="display:inline;">
                                                                        {{ method_field('DELETE') }} 
                                                                        {{ csrf_field() }}
                                                                    <button type="submit" class="btn btn-primary btn-sm" title="Delete treatments" onclick="return confirm("Confirm Delete?")>yes</button>
                                                                    </form>
                                                                </div>
                                                                </div>
                                                            </div>
    ...
    <script>
         @if( Session::get('danger'))
            Toastify({ text: "{{ Session::get('danger') }}", duration: 4000,
