        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <li class="nav-item">
            ...
            <li class="nav-item active">
                <a class="nav-link bg-info" href="{{ route('payment.info') }}">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mt-4">
                                ...
                                <div class="card-header bg-info py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-light">Payment Information</h6>
                                ...
                                <div class="card-body">
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            <button class="nav-link active text-dark fw-bold" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Unpaid Patient</button>
                                            <button class="nav-link text-dark fw-bold" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Paid Patient</button>
                                        </div>
                                    </nav>
                                                                ...
                                                                <tbody>
                                                                    @foreach ($unpaid as $u)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @if ($u->status == 0)
                                                                                    <span class="badge text-bg-primary">Unpaid</span>
                                                                                @endif
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
