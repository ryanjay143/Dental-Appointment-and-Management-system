    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link bg-info" href="{{ route('dentist.schedule') }}">
                <i class="fas fa-calendar-alt"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <div class="card mb-5 border border-info">
                            <div class="card-body">
                               <h4 class="fw-bold">Create Dentist Schedule for Unavailable</h4>
                               <form action="{{ route('schedules.store') }}" method="POST">
                                    @csrf

                                    <div class="mb-3">
                                        <input type="hidden" name="doctor_id" value="{{ Auth::user()->id }}" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="form-check mb-3">
                                        <input type="checkbox" class="form-check-input" name="availability" id="availability" required>
                                        <label class="form-check-label" for="availability">Unavailable</label>
                                    </div>
                                    <div class="d-grid gap-2">
                                        <button class="btn btn-info" type="submit">Create Schedule</button>
                                    </div>
                                </form>
