                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link active me-3 text-light" aria-current="page" href="{{ route('our.dentist') }}">Our Dentist</a>
                            ...
                            @foreach ($dentists as $dentist)
                                <a href=""><div class="card rounded shadow mt-5 mb-3 hover-zoom me-4 border border-info" style=" width: 20rem; display: inline-block; ">
                                    ...
                                    <div class="card-body text-dark text-start">
                                        <h6 class="card-title text-center text-muted">Fullname: Dr. {{ $dentist->firstname }} {{ $dentist->lastname }}</h6><hr>
                                        <!-- <h6 class="card-title">Email: {{ $dentist->email}}</h6><p class="card-text"></p><hr> -->
                                        <p class="card-title text-center text-muted p-0">Profession: 
