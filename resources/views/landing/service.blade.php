...
<body>
    <header>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link active me-3 text-light" aria-current="page" href="{{ route('services') }}">Services</a>
        ...
        <!-- Our Dental Services -->
        <section>
            <div class="container text-center mt-5 rounded border border-info">
                <div class="row">
                    <div class="col">
                        @if(!empty($treatments) && $treatments->count())
                            @foreach ($treatments as $treat)
                                <a href=""><div class="card rounded shadow mt-5 hover-zoom me-3 border border-info" style="width: 16rem; display: inline-block;">
                    ...
                    <div class=" pagination mt-5 justify-content-center">{{$treatments->links() }} </div>
                </div>
            </div>
        </section>
