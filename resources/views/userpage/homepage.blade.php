            ...
            <div class="container-fluid">
                ...
                <form class="d-flex" role="search">
                    ...
                    <div class="dropdown-center">
                        ...
                        <!-- <img src="{{ (!empty(Auth::user()->photo))? url('upload/patient_profile/'.Auth::user()->photo):url('images/avatar/profile.jpg') }}" alt="avatar"
                        class="rounded-circle" height="22" alt=""> -->
                        </button>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            <a class="nav-link active me-3 text-light" aria-current="page" href="{{ route('home') }}">Home</a>
                            ...
                            <!-- <a class="nav-link me-3 text-light" href="{{ route('appointmentTable') }}"><i class="far fa-calendar-check"></i> My Appointment</a> -->
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div class="card shadow border border-info" style="margin-top: 35px;">
                    ...
                    <div class="card-body">
                        <div class="container text-center">
                            ...
                            <a href="{{ route('dentalServices') }}"type="button" class="btn btn-outline-light mt-5 text-dark border border-info" data-mdb-ripple-color="dark">View more services</button></a>
                        </div>
                    </div>
                </div>    
            </div>
