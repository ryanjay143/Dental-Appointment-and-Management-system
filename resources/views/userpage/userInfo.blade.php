                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('pinfo') }}" method="POST"  class="row g-3" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="inputState" class="form-select border border-info border-1" name="month" id="month">
                                        ...
                                        <div class="col-md-4 mt-5">
                                            <input type="number" min="01" max="31" step="1" id="day" value="01" class="form-control border border-info border-1" placeholder="Day" name="day" value="{{ old('day') }}">
                                        </div>
                                        <div class="col-md-4 mt-5">
                                            <input type="number" min="1900" max="2023" step="1" id="year" value="2023" class="form-control border border-info border-1" placeholder="Year" name="year" value="{{ old('year') }}">
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" class="form-control border border-info border-1" id="address" placeholder="Barangay" name="location" value="{{ old('location') }}">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="inputCity" class="form-label text-info"> </label>
                                            <input type="text" class="form-control mt-2 border border-info border-1" id="state" placeholder="State/Province" name="state" value="{{ old('state') }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="inputZip" class="form-label"></label>
                                            <input type="text" class="form-control mt-2 border border-info border-1" id="zip_code" placeholder="Postal/Zip Code" name="zip_code" value="{{ old('zip_code') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputEmail4" class="form-label text-info ">Martial Status</label>
                                            <select class="form-select border border-info border-1" aria-label="Default select example" id="status" name="status">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select class="form-select border border-info border-1" aria-label="Default select example" id="gender" name="gender">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="name" class="form-control border border-info border-1" id="E_firstname" placeholder="Firstname" name="E_firstname" value="{{ old('E_firstname') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputPassword4" class="form-label text-info"></label>
                                            <input type="name" class="form-control mt-2 border border-info border-1" id="E_lastname" placeholder="Lastname" name="E_lastname" value="{{ old('E_lastname') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputEmail4" class="form-label text-info"></label>
                                            <input type="text" class="form-control mt-2 border border-info border-1" id="relationship" placeholder="Relationship" name="relationship" value="{{ old('relationship') }}">
                                        </div>
                                        <div class="col-md-6 mb-6">
                                            <label for="inputPassword4" class="form-label text-info"></label>
                                            <input type="text" class="form-control mt-2 border border-info border-1" id="E_contact_num" placeholder="Contact Number"  name="E_contact_num" value="{{ old('E_contact_num') }}">
                                        </div><hr>
                                        <div class="col-md-6">
                                            <label for="inputEmail4" class="form-label text-info">Weight(kilograms)</label>
                                            <input type="text" class="form-control border border-info border-1" id="weight" placeholder="Weight" name="weight" value="{{ old('weight') }}">
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label for="inputPassword4" class="form-label text-info">Height (feet)</label>
                                            <input type="text" class="form-control border border-info border-1" id="height" placeholder="Height" name="height" value="{{ old('height') }}">
                                        </div><hr>
